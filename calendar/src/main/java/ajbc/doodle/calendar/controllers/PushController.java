...
//			Notification notification = NotificationManager.notificationsQueue.poll();
			...
			System.out.println(user.getP256dh());
			System.out.println(user.getAuth());
			
			sendPushMessageToAllSubscribers(user.getEndpoint(), user.getP256dh(), user.getAuth(), new PushMessage("message: " + counter, notification.getMessage()));
			System.out.println(notification);
